...
if __name__ == "__main__":
    ...
    new_data_path = "D:/hongyouting/data/dnn/merge/features/2/cmorph_features.xlsx"  # 请替换为实际的新数据文件路径
    output_path = "D:/hongyouting/data/dnn/merge/features/2/cmorph_predictions.xlsx"
