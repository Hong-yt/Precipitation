...
def predict_new_data(model_path, scaler_path, new_data_path, output_path):
    ...
    try:
        # 读取所有数据
        full_data = pd.read_excel(new_data_path)
        print("成功读取数据文件")
...
if __name__ == "__main__":
    ...
    new_data_path = "D:/hongyouting/data/dnn/merge/features/2/gsmap_mvkg_features.xlsx"  # 请替换为实际的新数据文件路径
    output_path = "D:/hongyouting/data/dnn/merge/features/2/gsmap_mvkg_predictions.xlsx"
