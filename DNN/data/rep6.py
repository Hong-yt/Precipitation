...
if __name__ == "__main__":
    ...
    landuse_025_path = "D:/hongyouting/data/dnn/auxiliary/025/landuse/landuse_1440400.tif"  # 0.25°landuse文件
    landuse_1km_path = "D:/hongyouting/data/dnn/auxiliary/1km/1km_world/1440400_landuse.tif"  # 1km landuse文件
    station_csv_path = "D:/hongyouting/data/station/stations_summary.csv"  # 站点数据
    output_csv_path = "D:/hongyouting/data/dnn/rep/landuse_representativeness_results.csv"  # 输出文件
    detailed_output_path = "D:/hongyouting/data/dnn/rep/landuse_representativeness_detailed.csv"  # 详细输出文件
