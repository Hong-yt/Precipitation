...
def calculate_multiple_correlations(dataset1_path, dataset2_path, dataset3_path, dataset1_name, output_dir):
    ...
    # 保存总体比较结果
    overall_summary_path = os.path.join(output_dir, "IMERG_e7.txt")
...
if __name__ == "__main__":
    dataset1_path = "D:/hongyouting/data/0.25_clip_50/4930/imerg_e7_precipitation.npz"
    ...
    dataset1_name = "IMERG_e7"  # 你可以修改这里的名称
