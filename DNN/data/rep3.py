...
if __name__ == "__main__":
    auxiliary_025_path = "D:/hongyouting/data/dnn/auxiliary/025/ST/CLAY_1440400.tif"  # 0.25°auxiliary文件
    auxiliary_1km_path = "D:/hongyouting/data/dnn/auxiliary/1km/1km_world/ST/1440400_CLAY1.tif"  # 1km auxiliary文件
    station_csv_path = "D:/hongyouting/data/station/stations_summary.csv"  # 站点数据
    output_csv_path = "D:/hongyouting/data/dnn/rep/CLAY_representativeness_results.csv"  # 输出文件
    detailed_output_path = "D:/hongyouting/data/dnn/rep/CLAY_representativeness_detailed.csv"  # 详细输出文件
