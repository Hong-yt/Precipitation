...
def calculate_multiple_correlations(dataset1_path, dataset2_path, dataset3_path, dataset1_name, output_dir):
    ...
    # 保存总体比较结果
    overall_summary_path = os.path.join(output_dir, "GSMaP_nrt.txt")
...
if __name__ == "__main__":
    dataset1_path = "D:/hongyouting/data/0.25_clip_50/4930/gsmap_nrt_precipitation.npz"
    ...
    dataset1_name = "GSMaP_nrt"  # 你可以修改这里的名称
