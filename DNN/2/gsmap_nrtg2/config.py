...
class Config:
    ...
    FEATURES_PATH = f"D:/hongyouting/data/dnn/merge/features/1/{DATASET_NAME}_features.xlsx"
    TARGET_PATH = f"D:/hongyouting/data/dnn/merge/target/20464_target.xlsx"

    # 输出目录配置
    OUTPUT_DIR = 'D:/hongyouting/result/dnn/3/gsmap_nrtg2'
    ...
    # SHAP分析配置
    SHAP_ANALYSIS = False  # 是否进行SHAP分析
    ...
    # 超参数优化配置
    # 超参数优化配置
    HYPERPARAMETER_TUNING = False  # 是否进行超参数优化
