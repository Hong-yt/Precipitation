...
def calculate_multiple_correlations(dataset1_path, dataset2_path, dataset3_path, dataset1_name, output_dir):
    ...
    # 保存总体比较结果
    overall_summary_path = os.path.join(output_dir, "GSMaP_nrtg.txt")
...
if __name__ == "__main__":
    dataset1_path = "D:/hongyouting/some_preprocess/0.25_clip_50/4930/gsmap_nrtg_precipitation.npz"
    dataset2_path = "D:/hongyouting/some_preprocess/0.25_clip_50/4930/era5_precipitation.npz"
    dataset3_path = "D:/hongyouting/some_preprocess/0.25_clip_50/4930/sm2rain_precipitation.npz"
    output_dir = "D:/hongyouting/result/data_r"

    dataset1_name = "GSMaP_nrtg"  # 你可以修改这里的名称
