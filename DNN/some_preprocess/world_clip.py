...
if __name__ == "__main__":
    # 定义路径
    input_dir = r"D:/hongyouting/some_preprocess/dnn/auxiliary/1km/1km_clip"
    output_dir = r"D:/hongyouting/some_preprocess/dnn/auxiliary/1km/1km_world"

    # 世界大洲的shp文件路径 - 请替换为您实际的世界大洲shp文件路径
    # 这里假设您有一个世界大洲的shp文件，如果没有，您需要先获取一个
    continents_shp = r"D:/hongyouting/some_preprocess/clipshp/世界大洲.shp"  # 请替换为实际的shp文件路径
