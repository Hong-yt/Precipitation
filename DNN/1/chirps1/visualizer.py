...
class ResultVisualizer:
    ...
    def visualize_shap_feature_importance(self, importance_df, top_n=24):
        """
        可视化SHAP特征重要性
    ...
    def visualize_shap_summary(self, shap_values, features, feature_names=None, max_display=24, plot_type="bar"):
        """
        可视化SHAP摘要图
