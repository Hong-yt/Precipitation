    ...
    for station_id in station_ids:
        ...
        for level, (min_val, max_val, output_file) in levels.items():
            ...
            for _, row in station_subset.iterrows():
                ...
                if station_lat < -90 or station_lat > 90:
                    continue
...
if __name__ == '__main__':
    ...
    satellite_file = 'D:/hongyouting/data/0.25_clip/imerg_e7_4930_precipitation.npy'
    output_files = [
        'D:/hongyouting/result/station_statistics/categorization50/imerg_e7_light.csv',
        'D:/hongyouting/result/station_statistics/categorization50/imerg_e7_moderate.csv',
        'D:/hongyouting/result/station_statistics/categorization50/imerg_e7_heavy.csv'
    ]

    # station_folder = 'D:/hongyouting/data/GSOD'
    # satellite_file = 'D:/hongyouting/data/0.25_clip_60/cmorph_precipitation.npy'
    # output_files = [
    #     'D:/hongyouting/result/station_statistics/categorization/cmorph_light.csv',
    #     'D:/hongyouting/result/station_statistics/categorization/cmorph_moderate.csv',
    #     'D:/hongyouting/result/station_statistics/categorization/cmorph_heavy.csv'
    # ]

    # station_folder = 'D:/hongyouting/data/GSOD'
    # satellite_file = 'D:/hongyouting/data/0.25_clip_60/cdr_precipitation.npy'
    # output_files = [
    #     'D:/hongyouting/result/station_statistics/categorization/cdr_light.csv',
    #     'D:/hongyouting/result/station_statistics/categorization/cdr_moderate.csv',
    #     'D:/hongyouting/result/station_statistics/categorization/cdr_heavy.csv'
    # ]

    # station_folder = 'D:/hongyouting/data/GSOD'
    # satellite_file = 'D:/hongyouting/data/0.25_clip_50/chirps_precipitation.npy'
    # output_files = [
    #     'D:/hongyouting/result/station_statistics/categorization/chirps_light.csv',
    #     'D:/hongyouting/result/station_statistics/categorization/chirps_moderate.csv',
    #     'D:/hongyouting/result/station_statistics/categorization/chirps_heavy.csv'
    # ]
